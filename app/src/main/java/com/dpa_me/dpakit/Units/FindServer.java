...
import static com.dpa_me.dpakit.Units.HandleUnit.ApplicationID;

public class FindServer {
    String HttpRootAddress;
    ...
    public FindServer setRootAddress(String address){
        this.HttpRootAddress = address;
        return this;
    }
    ...
    public void setServerName(){
        ...
        retroInterface.getAddress_1(app_json.toString()).enqueue(new Callback<AppAddressModel>() {
            ...
            public void onResponse(Call<AppAddressModel> call, Response<AppAddressModel> response) {
                if (response.body().getMaintenance_break() == 1 && onOpration != null)
                    onOpration.onMaintenanceBreak();
                else {
                    HttpRootAddress = response.body().getAddress_1();
                    if (onOpration != null)
