...
import com.dpa_me.dpakit.Models.SimpleItem;
...
public class MyRadioGroup extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textView.setTextColor(attributes.getInt(R.styleable.MyRadioGroup_captionColor, R.color.light_text));
    ...
    private void setRadioData(final MyRadioButton rb, int pos){
        rb.setText(CaptionList.get(pos).getTitle());
        rb.setTag(CaptionList.get(pos).getId());
